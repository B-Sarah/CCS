...
public class CCSSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CCSPackage.ROLE: {
			...
			if (result == null)
				result = caseInterfaceElement(role);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CCSPackage.PORT: {
			...
			if (result == null)
				result = caseIComponentElement(port);
			if (result == null)
				result = caseInterfaceElement(port);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CCSPackage.SERVICE: {
			...
			if (result == null)
				result = caseIComponentElement(service);
			if (result == null)
				result = caseInterfaceElement(service);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CCSPackage.ICOMPONENT_ELEMENT: {
			IComponentElement iComponentElement = (IComponentElement) theEObject;
			T result = caseIComponentElement(iComponentElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CCSPackage.ILINK: {
		...
		case CCSPackage.PORT_CONFIGURATION: {
			...
			if (result == null)
				result = caseInterfaceElement(portConfiguration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IComponent Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IComponent Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIComponentElement(IComponentElement object) {
		return null;
	}
